...
public class Crushing implements enchantmentInterface {


    @Override
    public String getName() {return "Crushing";}

    @Override
    public String getDescription(){return "Deals Double damage!";}
    @Override
    ...
    public void applyOffensive(int a, EntityDamageByEntityEvent event){
        System.out.println("Damage increased: " + a);
    }
