...
public class HealthBoost implements enchantmentInterface {


    @Override
    public String getName() {return "Health Boost";}
    @Override
    public String getDescription(){return "Gives player health boost";}
    @Override
